...
from utils_hoo.utils_datsci.utils_stats import r2
...
if __name__ == '__main__':
    ...
    # 交叉验证CV网格------------------------------------------------------------
    parms_mdl = {}
    best1, s1 = lgb_cv_GridSearch(X_train, y_train, objective='regression',
    ...
    best2, s2 = lgb_cv_GridSearch(X_train, y_train, objective='regression',
    ...
    best3, s3 = lgb_cv_GridSearch(X_train, y_train, objective='regression',
